...
#include "hw/forest_defender_hardware.h"
#include "common.h"
...
///	<summary>
///		Initializes audio buffers, prediction models, and peripherals.
///	</summary>
...
/// <summary>
///		Processes new predictions by converting each event into a string
	...
	size_t size, unsigned char** response, size_t* response_size, void* userContextCallback)
{
	...
	{
		SimulateEvent();
		const char deviceMethodResponse[] = "{ \"Response\": \"Simulating fire event\" }";
